    ...
    <div className='bg-[url("../assets/images/background-login.png")] bg-[length:100%_100%] w-full min-h-screen max-w-none flex'>
      <div className="bg-black/40 w-full flex">
        <form 
          ...
          <input 
            className="border border-white bg-black/80 p-1" 
          ...
          <button 
            type="submit" 
            className="self-center py-1 px-3 border border-white bg-black/50 hover:text-white/80 hover:border-white/80" >
              Ingresar
          </button>
        </form>
      </div>      
